...
export const basicInfo = {
  id: 1,
  fullName: "Idriz Mehmedovic",
  address: "Kamenica Donja, 164",
  ZIP: "75410",
  city: "Drinjaca",
  country: "BiH",
...
export const education = [
  ...
  },
  {
    ...
    city: "Tuzla",
    school: "IPI Academy",
    dateRange: "2017-ongoing",
    description:
      "I attend a study program of Information Technology where we are training to define and solve complex engineering problems as well as communication skills and skills of cooperating and working in teams."
  }
];
...
export const workExperience = [
  ...
  },
  {
    id: 2,
    position: "Volunteer",
    organization: "BH Engineering Week Tuzla",
    dateRange: "2018",
    description:
  ...
  {
    id: 4,
    position: "Web Application Penetration Testing",
    organization: "---",
    dateRange: "2015-2016",
    description:
